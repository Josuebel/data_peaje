...
class RegistroRuta {
    ...
    cargarRutas() {
        ...
        this.rutaAPIRegistro.get("/list", registroControlador_1.default.listarUsuarios);
        this.rutaAPIRegistro.delete("/delete/:codUsuario", registroControlador_1.default.eliminarUsuario);
    }
}
